...
def generate_one_seq(prompts: List[str], model: Transformer, tokenizer: Tokenizer, *, max_tokens: int, chunk_size: int = None, temperature: float = 0.7, echo_prompt: bool = False):
    model = model.eval()
    ...
    if generated_tokens:
        ...
        for i, x in enumerate(encoded_prompts):
            if echo_prompt:
                ...
                generated_words.append(tokenizer.decode(generated_tokens[i].tolist()))

    return generated_words, generated_tokens, logprobs
